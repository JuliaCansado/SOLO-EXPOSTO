...
// 02_CLASSIFICAÇÃO - SOLO EXPOSTO: O (in)definido na Região Metropolitana de São Paulo

// DESCRIÇÃO: Código de classificação de áreas de solo exposto escuro para 2022.
...
Map.addLayer(planetFiltWet_2022,imageVisParamPlanet,'Planet - 2022');
...
Export.image.toAsset({image: classifiedPlanet_2022, 
                    description: 'planet_2022_class_OA', 
                    assetId: 'users/juliacansado/TFG/PROMISSORES/planet_2022_class_OA', 
                    region: RMSP_box, 
